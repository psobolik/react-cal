      ...
      <div style={{gridRow: "2/4", gridColumn: 2}}>
        <div id="calendar">
          <div className="calendar-row">
            <div style={{gridRow: 1, gridColumn: 1}} className="cell heading">Sunday</div>
            <div style={{gridRow: 1, gridColumn: 2}} className="cell heading">Monday</div>
            <div style={{gridRow: 1, gridColumn: 3}} className="cell heading">Tuesday</div>
            <div style={{gridRow: 1, gridColumn: 4}} className="cell heading">Wednesday</div>
            <div style={{gridRow: 1, gridColumn: 5}} className="cell heading">Thursday</div>
            <div style={{gridRow: 1, gridColumn: 6}} className="cell heading">Friday</div>
            <div style={{gridRow: 1, gridColumn: 7}} className="cell heading">Saturday</div>
          </div>
